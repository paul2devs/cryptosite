...
exports.renderPasswordResetRequestEmail = renderPasswordResetRequestEmail;
...
function renderPasswordResetRequestEmail(args) {
...
function renderPasswordChangedEmail(args) {
    const baseUrl = (0, emailClient_1.getAppBaseUrl)();
